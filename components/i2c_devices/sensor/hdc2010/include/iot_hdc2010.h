...
{
private:
    hdc2010_handle_t m_sensor_handle;
    CI2CBus *bus;
    /**
     * prevent copy constructing
     */
    CHdc2010(const CHdc2010&);
    CHdc2010& operator =(const CHdc2010&);
public:
    /**
     * @brief constructor of CHdc2010
     *
     * @param p_i2c_bus pointer to CI2CBus object
     * @param addr slave device address
     */
    CHdc2010(CI2CBus *p_i2c_bus, uint8_t addr);
     ...
     * @return
     *     - HDC2010_ERR_VAL if fails
     *     - Others, (float)temperature value
     */
     ...
     * @brief   get interrupt info
     *
     * @param   info hdc2010_interrupt_info_t
     *
     * @return
     *     - ESP_OK Success
     *     - ESP_FAIL Fail
     */
    esp_err_t interrupt_info(hdc2010_interrupt_info_t * info);

    /**
     * @brief   set interrupt config
     *
     * @param   config hdc2010_interrupt_config_t
     *
     * @return
     *     - ESP_OK Success
     *     - ESP_FAIL Fail
     */
    esp_err_t set_interrupt_config(hdc2010_interrupt_config_t * config);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_temperature_offset(uint8_t offset_data);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_humidity_offset(uint8_t offset_data);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_humidity_threshold(float humidity_data);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_reset_and_drdy(hdc2010_reset_and_drdy_t * config);
     ...
     *     - ESP_FAIL Fail
     */
    esp_err_t set_measurement_config(hdc2010_measurement_config_t * config);
     ...
     * @return
     *     - HDC2010_ERR_VAL if fails
     *     - Others, manufacturer id value
     */
    int manufacturer_id(void);
